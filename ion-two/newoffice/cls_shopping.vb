...
Public Class cls_shopping
    ...
    Function GetCSV()
        ...
        oSQLcmd1.CommandText = "select * from vv_allitems_full where (itemdeleted = 0) and (qtyonstock_cur > 0) and (shopstatus = 1) and (sell_price > 0) and (  ( (suppliernumber=96 or suppliernumber=99) and branchnumber=1 ) or ( (suppliernumber=1  and branchnumber=2 )   )) "
        ...
        For Each row As DataRow In oDs.Tables(0).Rows
            ...
            item.Add(Chr(34) + "000" + Chr(34))
            item.Add(Chr(34) + "000" + Chr(34))
            item.Add(Chr(34) + "Twin Diamonds" + Chr(34))
            ...
            item.Add("http://www.twin-diamonds.com/catalog/myitemv3.aspx?id=" + oPlate._id.ToString)

            item.Add(Chr(34) + oPlate._picture_hires_pic + Chr(34))
            
            item.Add(Chr(34) + "Jewelry" + Chr(34))
            item.Add(Chr(34) + "0" + Chr(34))

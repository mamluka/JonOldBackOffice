...
Public Class cls_sharesale
    ...
    Function GetCSV()
        ...
        oSQLcmd1.CommandText = "select * from vv_allitems_full where (itemdeleted = 0) and (qtyonstock_cur > 0) and (shopstatus = 1) and (sell_price > 0) and (  ( (suppliernumber=96 or suppliernumber=99) and branchnumber=1 ) or ( ( branchnumber=2 )   ))"
        ...
        For Each row As DataRow In oDs.Tables(0).Rows
            ...
            If Not IsNothing(oPlate) Then
                ...
                item.Add(Chr(34) + oPlate._itemnumber + Chr(34))
                item.Add(Chr(34) + desc + Chr(34))
                item.Add(Chr(34) + "http://www.twin-diamonds.com/catalog/myitem.aspx?id=" + oPlate._id.ToString + Chr(34))
                item.Add(Chr(34) + Format(oPlate._pricing._correct_price, "##0.00").ToString + Chr(34))
                item.Add(Chr(34) + Format(oPlate._appraisal_price, "##0.00").ToString + Chr(34))
                item.Add(Chr(34) + oPlate._picture_hires_pic + Chr(34))
                item.Add(Chr(34) + oPlate._icon_pic + Chr(34))
                item.Add(Chr(34) + (oPlate._pricing._correct_price * 0.1).ToString + Chr(34))
                item.Add(Chr(34) + "8" + Chr(34))
                item.Add(Chr(34) + "64" + Chr(34))

                item.Add(Chr(34) + info + Chr(34))

                Dim searchterms As New ArrayList
                searchterms.Add(oPlate._category_name)
                searchterms.Add(oPlate._subcategory_name)
                Select Case oPlate._platetype
                    Case 1
                        searchterms.Add(oPlate._subplate._s_weight)
                        searchterms.Add(oPlate._subplate._colorfrom)
                        searchterms.Add(oPlate._subplate._clarityfrom)
                    Case 2

                        searchterms.Add(oPlate._subplate._s_weight)
                        searchterms.Add(oPlate._subplate._colorfrom)
                        searchterms.Add(oPlate._subplate._clarityfrom)
                        searchterms.Add(oPlate._subplate._stonetype)
                    Case 3
                        searchterms.Add(oPlate._subplate._jewelrytype)
                        searchterms.Add(oPlate._subplate._jewelrysubtype)
                        searchterms.Add(oPlate._subplate._metal)
                        searchterms.Add(oPlate._subplate._middlestone)
                ...
                item.Add(Chr(34) + Join(searchterms.ToArray, ",").Replace(vbNewLine, " ") + Chr(34))
                item.Add(Chr(34) + "instock" + Chr(34))
                item.Add("17781")
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + oPlate._category_name + Chr(34))
                item.Add(Chr(34) + oPlate._subcategory_name + Chr(34))
                item.Add(desc)
                item.Add(Chr(34) + "" + Chr(34))
                item.Add(Chr(34) + "" + Chr(34))

...
Public Class cls_CJ_cart
    ...
    Public ocart As New ion_two.cls_advanced_cart
    ...
    Public Function cJ_addall(ByVal oCJobj As ion_two.cls_custom_jewel_skl)
        ...
        If oCJobj.has_cs Then
            ocart.add_normal_item(oCJobj.cs_item_id, , 1)
        End If
    ...
    Function cE_addall(ByVal oceitem As ion_two.cls_custom_earrings_diamond_skl)
        ...
        ologic.create_extrainfo(oceitem.price, omodceitem.description, oceitem.setting_id, omodceitem.extrainfo)

        omodceitem.price = oceitem.price

        omodceitem.picsrc = oceitem.picsrc

        ocart.add_mod_item(oceitem.true_id, 5, omodceitem, 1, , True)

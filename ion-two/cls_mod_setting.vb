Public Class cls_mod_setting
    ...
    Public Function ds_create_extrainfo(ByVal price As Decimal, ByVal metaltype As String, ByVal designid As Int32, ByRef extrainfo As String, Optional ByVal picsrc As String = "")

        If picsrc = "" Then
            extrainfo = "DGS|" + Convert.ToString(price) + "|" + metaltype + "|" + Convert.ToString(designid) + "|"
        Else
            extrainfo = "DGS|" + Convert.ToString(price) + "|" + metaltype + "|" + Convert.ToString(designid) + "|" + picsrc + "|"
        End If

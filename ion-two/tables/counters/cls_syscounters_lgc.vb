Public Class cls_syscounters_lgc
	...
	Public Function get_counter(ByRef nId As Int32, ByRef nCounter As Int32) As Boolean
		...
		oTmpDataBroker._table = "sys_counters"
...
ErrorHandler:
	...
	Public Function set_counter(ByVal nId As Int32, ByVal nCounter As Int32) As Boolean
		On Error GoTo ErrorHandler
		...
		If Not IsNothing(Me._idac_transaction) Then
			oDacCommand._transaction = Me._idac_transaction._transaction
		End If
		oDacCommand._sqlstring = "update sys_counters set counter = " + Convert.ToString(nCounter) + " where id=" + Convert.ToString(nId)

Public Class cls_search_library_rubies
	Inherits ion_two.cls_search_library

	Public Function get_rubies_loose_1(ByVal nWeight As Int16, ByVal cShape As String, ByVal nPrice As Int16, ByVal bIsDealer As Boolean, ByRef cSQLstring As String) As Boolean
		On Error GoTo ErrorHandler
		Dim bError As Boolean = False

		cSQLstring = "select * from vv_gemstones_full where (category_id = 3) and (subcategory_id = 11) "
...
ErrorHandler:
	...
	Public Function get_rubies_fine(ByVal nMode As Int16, ByVal cShape As String, ByRef cSQLstring As String) As Boolean
		On Error GoTo ErrorHandler
		Dim bError As Boolean = False
...
ErrorHandler:
	...
	Public Function get_rubies_pairs(ByVal cShape As String, ByRef cSQLstring As String) As Boolean
		On Error GoTo ErrorHandler
		Dim bError As Boolean = False

		cSQLstring = "select * from vv_gemstones_full where (category_id = 3) and (subcategory_id = 12) "

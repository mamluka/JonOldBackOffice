Public Class cls_rates_lgc
    Inherits iFoundation.cls_logics_sub

    Sub New()
        '--- Set working table
        Me._tablename = "acc_RATES"
    ...
    Function insert(ByRef oDataTable As skl_rates) As Boolean
        ...
        '--- Get Dataset
        Dim oTmpDataset As DataSet = New ion_two.ds_rates
        ...
        oTmpDataRow("NAME") = oDataTable._name
        oTmpDataRow("CODE") = oDataTable._code
        oTmpDataRow("VALUE") = oDataTable._value
...
ErrorHandler:
    ...
    Function read(ByVal nId As Int32, ByRef oDataTable As skl_rates) As Boolean
        On Error GoTo ErrorHandler
        ...
        oReadTransactor._searchfield = "ID"
        ...
        oDataTable._name = oTmpDataRow("name")
        oDataTable._code = oTmpDataRow("code")
        oDataTable._value = oTmpDataRow("value")
...
ErrorHandler:
    ...
    Function update(ByRef oDataTable As skl_rates) As Boolean
        On Error GoTo ErrorHandler

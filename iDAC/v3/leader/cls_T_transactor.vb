...
Public Class cls_T_transactor
	...
	Function transact_insert() As Boolean
		...
		Me._broker._i_cll_datatables = Me._i_cll_datatables

		'--- Call function
		bError = Me._broker.transact_insert
		If bError Then
		...
		Me._i_cll_datatables = Me._broker._i_cll_datatables
...
ErrorHandler:
	...
	Function transact_update() As Boolean
		...
		'--- Call function
		bError = Me._broker.transact_update
		If bError Then
			Me._err_number = Me._broker._err_number
			Me._err_description = Me._broker._err_description
			Me._err_source = Me._broker._err_source
...
ErrorHandler:
	...
	Private Function get_broker()
		...
		Select Case Me._dbtype
			Case 1
				Me._broker = New cls_sql_transactor

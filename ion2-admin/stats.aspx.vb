...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '--- create connection
        oConnection.ConnectionString = Application("config").connection_logging
        oDataAdapter1.TableMappings.Add("Table", "log_SESSIONS_site")

        oSQLcmd1.CommandText = "select * from log_SESSIONS_site order by id"
        ...
        grd_items.DataMember = "log_sessions_site"
        grd_items.DataBind()

...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oDataAdapter1.TableMappings.Add("Table", "acc_account_names")

        oSQLcmd1.CommandText = "select * from v_account_names"
        ...
        grd_items.DataMember = "acc_account_names"
        grd_items.DataBind()
...
ErrorHandler:
        ...
        Session("error").app_call = "listaccounts / PageLoad"

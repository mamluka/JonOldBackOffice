...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Request.QueryString("count") = "1" Then
            ...
            For i = pagestart To pageend
                ...
                oTmpOrder.get_order_by_id(oDs.Tables(0).Rows(i)("order_id"), oOrder)

                array2.Add(oDs.Tables(0).Rows(i)("order_id").ToString)
                array2.Add(oOrder.OrderDate.ToShortDateString)
                array2.Add(oOrder.invoice_number.ToString)
                array2.Add(oDs.Tables(0).Rows(i)("CustomerName"))
                array2.Add(oDs.Tables(0).Rows(i)("CustomerEmail"))
                array2.Add(oOrder.sts_curr_stat)
                array2.Add(FormatNumber(oOrder.amnt_grandtotal, 2, TriState.False, TriState.False, TriState.False))
                array2.Add("$")
                array2.Add("")
    ...
    Function CreateSql(ByVal qhash As Hashtable, Optional ByVal count As Boolean = False) As String
        ...
        If qhash.ContainsKey("ordernumber") Then
            andarray.Add("order_id = " + qhash("ordernumber"))
        End If

        If qhash.ContainsKey("email") Then
            andarray.Add("CustomerEmail like '" + qhash("email").replace("*", "%") + "'")
        End If

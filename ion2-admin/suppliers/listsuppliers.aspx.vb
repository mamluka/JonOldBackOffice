...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oDataAdapter1.TableMappings.Add("Table", "spl_suppliers")

        oSQLcmd1.CommandText = "select id2, branch_id, suppliernumber, company, tel1, telcell from spl_suppliers order by branch_id,suppliernumber"
        oSQLcmd1.CommandType = CommandType.Text
        oDataAdapter1.SelectCommand = oSQLcmd1

        Dim oDs As DataSet
        oDs = New DataSet("suppliers")

        oConnection.Open()
        oDataAdapter1.Fill(oDs)

        grd_items.DataSource = oDs
        grd_items.DataMember = "spl_suppliers"
        grd_items.DataBind()
...
ErrorHandler:
        ...
        Session("error").app_call = "listsuppliers / PageLoad"

<%@ Page Language="vb" AutoEventWireup="false" Codebehind="supplierstatus.aspx.vb" Inherits="ion_admin.supplierstatus"%>
	...
	<body bottomMargin="2" bgColor="#a9a9a9" leftMargin="2" topMargin="2" rightMargin="2" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="tbl_main" cellSpacing="1" cellPadding="1" width="651" bgColor="#d3d3d3" border="0">
				<TR>
					<TD bgColor="#708090"><asp:label id="lbl_caption" runat="server" Font-Bold="True" Font-Names="verdana,arial" Font-Size="10pt" ForeColor="Khaki" Width="404px"> Supplier status:</asp:label></TD>
				</TR>
				<TR>
					<TD><asp:datagrid id="grd_items" runat="server" Font-Names="verdana,arial" Font-Size="8pt" Width="650px" BorderColor="White" BackColor="Linen" BorderWidth="1px" BorderStyle="Outset" AutoGenerateColumns="False" AllowPaging="True" PageSize="15" CellPadding="1">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="amount_ils" HeaderText="Amount-ILS" DataFormatString="{0:N} ils"></asp:BoundColumn>
							</Columns>
				...
				<TR>
					<TD align="right">
						<asp:Label id="Label1" runat="server" Font-Bold="True" Font-Names="verdana,arial" Font-Size="10pt" ForeColor="MidnightBlue" Width="60px">Total:</asp:Label>

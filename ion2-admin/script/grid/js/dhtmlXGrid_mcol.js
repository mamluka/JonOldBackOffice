...
dhtmlXGridObject.prototype._processAllArrays = function(oldInd,newInd,vals){
 var ars=["hdrLabels","cellWidth","cellType","cellAlign","cellVAlign","fldSort","columnColor","_hrrar","_c_order","combos"];
 if(this.cellWidthPX.length)ars[1]="cellWidthPX";
 else ars[1]="cellWidthPC";

/*
Last Modified: 12/05/07 21:03:11
...
AJS.Drag = AJS.Class({
    ...
    _move: function(ev) {
        ...
        var elm_pos = AJS.absolutePosition(root);

        var new_x = elm_pos.x + (cur_mouse_pos.x - last_mouse_pos.x);
        var new_y = elm_pos.y + (cur_mouse_pos.y - last_mouse_pos.y);

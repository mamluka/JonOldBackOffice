...
////
    ...
    getRequest: function(url,data,type,restype) {
    ...
    _sendXMLHttpRequest: function(req, data,restype) {
        var d = new AJSDeferred(req,restype);
...
AJSDeferred = function(req,restype) {
    this.callbacks = [];
    this.errbacks = [];
    this.req = req;

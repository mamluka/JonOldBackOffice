<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ebaycsv_au.aspx.vb" Inherits="ion_admin.ebaycsv_au"%>
				...
				<tr>
					...
					<td style="HEIGHT: 21px">
						<asp:dropdownlist id="cmb_site" runat="server">
							...
							<asp:ListItem Value="15" Selected="True">Australia</asp:ListItem>
							<asp:ListItem Value="71">France</asp:ListItem>
							<asp:ListItem Value="101">Italy</asp:ListItem>
						</asp:dropdownlist><BR>
						<BR>
						<asp:TextBox id="e_currency" runat="server" Width="32px">1</asp:TextBox></td>
				</tr>
				<tr>
					<td>Format</td>
					<td>
